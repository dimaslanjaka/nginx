...
public class WebkitCookieManagerProxy extends java.net.CookieManager implements CookieJar {
    ...
    public void saveFromResponse(HttpUrl url, List<Cookie> cookies) {
        ...
        try {
            ...
            Log.e("Error adding cookies through okhttp", e);
        }
    }
